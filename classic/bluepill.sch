...
U 1 1 5DE0F7EB
P 8150 5150
F 0 "J5" H 8230 5142 50  0000 L CNN
F 1 "SWD" H 8230 5051 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Horizontal" H 8150 5150 50  0001 C CNN
...
U 1 1 5DE3364B
P 4650 3000
F 0 "C4" H 4765 3046 50  0000 L CNN
...
U 1 1 5DE33802
P 5050 3000
F 0 "C6" H 5165 3046 50  0000 L CNN
...
U 1 1 5DE8103C
P 3800 1200
F 0 "R5" H 3870 1246 50  0000 L CNN
...
U 1 1 5DEB4436
P 9150 4150
F 0 "#PWR032" H 9150 3900 50  0001 C CNN
...
U 1 1 5DEC7575
P 10900 950
F 0 "#PWR039" H 10900 800 50  0001 C CNN
...
U 1 1 5DEC7CC8
P 9700 1200
F 0 "C10" H 9815 1246 50  0000 L CNN
...
U 1 1 5DECBD3F
P 9700 1350
F 0 "#PWR034" H 9700 1100 50  0001 C CNN
...
U 1 1 5E02788D
P 7350 5200
F 0 "C9" H 7235 5154 50  0000 R CNN
...
U 1 1 5E0C47D9
P 2800 5300
F 0 "#PWR08" H 2800 5150 50  0001 C CNN
...
U 1 1 5E0B0BD6
P 7350 5400
F 0 "#PWR030" H 7350 5150 50  0001 C CNN
...
U 1 1 5DE0CCFF
P 4900 1400
F 0 "C5" H 4750 1500 50  0000 L CNN
...
U 1 1 5DEF6246
P 3850 2450
F 0 "R4" V 4057 2450 50  0000 C CNN
...
U 1 1 5E3B8BCE
P 7000 1500
F 0 "D3" H 6993 1245 50  0000 C CNN
...
U 1 1 5E3E3874
P 7000 1150
F 0 "D2" H 6993 895 50  0000 C CNN
...
U 1 1 5E3EB2C9
P 7550 1550
F 0 "#PWR031" H 7550 1300 50  0001 C CNN
...
U 1 1 5E43AA5C
P 10500 1350
F 0 "#PWR038" H 10500 1100 50  0001 C CNN
...
U 1 1 5E43AEB9
P 10900 1350
F 0 "#PWR040" H 10900 1100 50  0001 C CNN
...
U 1 1 5E5BBA7B
P 5950 6450
F 0 "#PWR020" H 5950 6300 50  0001 C CNN
...
U 1 1 5E5BBD9C
P 5950 6650
F 0 "#PWR021" H 5950 6400 50  0001 C CNN
...
U 1 1 5E5D19A3
P 6100 5000
F 0 "#PWR022" H 6100 4850 50  0001 C CNN
...
U 1 1 5E61B0D9
P 6350 6750
F 0 "#PWR023" H 6350 6600 50  0001 C CNN
...
U 1 1 5DE28743
P 7250 3300
F 0 "#PWR028" H 7250 3050 50  0001 C CNN
...
U 1 1 5DE25D99
P 7250 3100
F 0 "C8" H 7365 3146 50  0000 L CNN
...
U 1 1 5E1166B3
P 2350 5700
F 0 "C2" H 2235 5654 50  0000 R CNN
...
U 1 1 5E133F34
P 2800 5700
F 0 "C3" H 2685 5654 50  0000 R CNN
...
U 1 1 5E16F790
P 3700 2350
F 0 "#PWR012" H 3700 2200 50  0001 C CNN
...
U 1 1 5E16FCCD
P 3200 2350
F 0 "#PWR010" H 3200 2200 50  0001 C CNN
...
U 1 1 5E620338
P 9450 5550
F 0 "#PWR036" H 9450 5300 50  0001 C CNN
...
U 1 1 5E61F79C
P 9450 5400
F 0 "C11" H 9565 5446 50  0000 L CNN
...
U 1 1 5E61DE4A
P 9450 5100
F 0 "D4" V 9496 5021 50  0000 R CNN
F 1 "BAT60J" V 9405 5021 50  0000 R CNN
F 2 "Diode_SMD:D_SOD-323_HandSoldering" H 9450 4925 50  0001 C CNN
F 3 "http://www.vishay.com/docs/88525/1n5817.pdf" H 9450 5100 50  0001 C CNN
	1    9450 5100
	0    -1   -1   0   
$EndComp
$Comp
...
F 1 "+3.3V" H 9465 5078 50  0000 L CNN
...
F 1 "+BATT" H 9315 5173 50  0000 C CNN
